...
const App = () => {
  ...
  const [circlePositionDesktop, setCirclePositionDesktop] = useState("250px");
    ...
    if(!isNaN(key) || key === "."){
      ...
      const calculate = (a, b, op) => {
        switch(op){
          ...
          case "-" : return a - b;
          case "x" : return a * b;
          case "/" : return b != 0 ? a / b : "Divide by 0 error";
        ...
        const pageStyles = (value) => {
          if(value === "theme1"){
            ...
            setCirclePositionDesktop("563px")
            ...
            setCirclePositionDesktop("546px");
            ...
            setCirclePositionDesktop("526px")
      ...
      <main>
        <div className="heading_theme_btn">
          ...
          <div className="theme_btn_div">
            ...
            <span className="circle lg:hidden" style={{ backgroundColor: circleColor, right: circlePosition }}></span>
            <div className="absolute lg:hidden flex gap-2 top-[2.7rem] right-4" style={{ color: primaryColor }}>
            <span>1</span>
            <span>2</span>
            <span>3</span>
            </div>
            <span className="circle hidden lg:block" style={{ backgroundColor: circleColor, right: circlePositionDesktop }}></span>
            <div className="absolute hidden lg:flex gap-2 top-[2.7rem] right-[16.5rem]" style={{ color: primaryColor }}>
            <span>1</span>
            <span>2</span>
            <span>3</span>
            </div>
        ...
        <div className="w-[325px] lg:w-[400px] mx-auto h-[70px] flex items-center justify-end pt-1 mt-4 rounded-[10px] overflow-x-auto scroll-container" style={{ backgroundColor: screenBg}}>
          <div className="px-2" style={{ color: primaryColor }}>
            {formattedNumber}
          </div>
        </div>

        <div className="w-[325px] lg:w-[400px] mx-auto h-[435px] mt-3 rounded-[10px]" style={{ backgroundColor: inputDivBg}}>

          <div className="flex gap-2 flex-wrap py-3 justify-center">
          {keys.map((btnKey) => (
            <div 
            key={btnKey} 
            className={`${btnKey === "RESET" || btnKey === "=" ? "w-[136px] lg:w-[176px]" : "w-[60px] lg:w-[80px]"}
             h-[65px] flex items-center justify-center text-sm rounded-sm cursor-pointer shadow-sm inset 0px -10px 10px 0px rgba(0,0,0,0.38)`}
